...
ggplot(df, aes(x=M1, y=M2)) + geom_point() + labs(title = "M2 as a function of M1")
...
df_km_color <- lapply(kmin:kmax, function(x) {df %>% mutate(cluster = as.factor(km[[x]]$cluster))})

ggplot(df_km_color[[1]], aes(x=M1, y=M2, color=cluster)) + geom_point() + labs(title = "Clustering with kmeans, k=1")
ggplot(df_km_color[[2]], aes(x=M1, y=M2, color=cluster)) + geom_point() + labs(title = "Clustering with kmeans, k=2")
ggplot(df_km_color[[3]], aes(x=M1, y=M2, color=cluster)) + geom_point() + labs(title = "Clustering with kmeans, k=3")
ggplot(df_km_color[[4]], aes(x=M1, y=M2, color=cluster)) + geom_point() + labs(title = "Clustering with kmeans, k=4")
ggplot(df_km_color[[5]], aes(x=M1, y=M2, color=cluster)) + geom_point() + labs(title = "Clustering with kmeans, k=5")
...
km_evaluation_df <- tibble(k = c(1:5),
